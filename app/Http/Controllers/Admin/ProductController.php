...
class ProductController extends Controller
{
    ...
    // public function ProductHighlightRemove($id){}
    // public function ProductHighlightEdit($id){}
    public function ProductHighlightUpdate($id){}
    // public function ProductHighlightDelete($id){}
