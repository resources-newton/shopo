...
class SellerProductController extends Controller
{
    ...
    public function productHighlight($id){
        $product = Product::with('category','seller','brand')->find($id);
        $product->highlight = 1;
        $product->save();
        return response()->json(['message' => 'Product Highlighted Successfully']);
    }
    // public function productUnHighlight($id){
    //     $product = Product::with('category','seller','brand')->find($id);
    //     $product->highlight = 0;
    //     $product->save();
    //     return response()->json(['message' => 'Product Unhighlighted Successfully']);
    // }
    ...
    public function create()
    {
        ...
        public function productHighight(){
